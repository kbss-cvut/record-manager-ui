...
export function login(username, password) {
  return function (dispatch) {
    ...
    axiosBackend
      .post(`${API_URL}/j_spring_security_check`, `username=${username}&password=${password}`, {
...
export function passwordReset(email) {
  return function (dispatch) {
    ...
    axiosBackend
      .post(`${API_URL}/rest/users/password-reset`, email, { headers: { "Content-Type": "text/plain" } })
      .then(() => {
...
export function validateToken(token) {
  return function (dispatch) {
    ...
    axiosBackend
      .post(`${API_URL}/rest/users/validate-token`, token, { headers: { "Content-Type": "text/plain" } })
      .then(() => {
