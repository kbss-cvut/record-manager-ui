...
export function deleteInstitution(institution) {
  return function (dispatch, getState) {
    ...
    return axiosBackend
      .delete(`${API_URL}/rest/institutions/${institution.key}`, {
        ...institution,
      })
      .then(() => {
      ...
      .catch((error) => {
        ...
        dispatch(
          publishMessage(
            errorMessage("institution.delete-error", {
...
export function loadInstitution(key) {
  ...
  return function (dispatch) {
    ...
    return axiosBackend
      .get(`${API_URL}/rest/institutions/${key}`)
      .then((response) => {
...
export function createInstitution(institution) {
  ...
  return function (dispatch) {
    ...
    return axiosBackend
      .post(`${API_URL}/rest/institutions`, {
        ...institution,
      })
      .then((response) => {
...
export function updateInstitution(institution) {
  ...
  return function (dispatch) {
    ...
    return axiosBackend
      .put(`${API_URL}/rest/institutions/${institution.key}`, {
        ...institution,
      })
      .then(() => {
