...
export default {
  ...
  messages: {
    ...
    "login.reset-password-error":
      "Resetting password failed. Please contact an administrator if the provided email is correct.",
    ...
    "records.import.partialSuccess.message":
      "Imported {importedCount} out of {totalCount, plural, one {# record} other {# records}}. Check server log for details.",
    ...
    "records.form-template-version": "Form template version: {version}",
    ...
    "The passed institution's key is different from the specified one.":
      "The passed institution's key is different from the specified one.",
    "The passed record's key is different from the specified one.":
      "The passed record's key is different from the specified one.",
    "The passed user's current password is different from the specified one.":
      "The passed user's current password is different from the specified one.",
    "The passed user's username is different from the specified one.":
      "The passed user's username is different from the specified one.",
