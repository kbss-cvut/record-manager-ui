...
export default {
  ...
  messages: {
    ...
    "login.reset-password-error":
      "Resetování hesla se nezdařilo. Pokud je zadaný e-mail správný, kontaktujte administrátora.",
    ...
    "records.closed-study.create-tooltip":
      "Studie je uzavřená na přidávání pacientů. Prosím, kontaktujte studijního koordinátora v připadě, že potřebujete přidat nový záznam pacienta.",
    ...
    "records.import.partialSuccess.message":
      "{importedCount, plural, one {Importován #} few {Importovány #} other {Importováno #}} z {totalCount, plural, one {# záznamu} other {# záznamů}}. Detaily naleznete v logu serveru.",
    "records.import.success.message":
      "Úspěšně {importedCount, plural, one {importován # záznam} few {importovány všechny # záznamy} other {importováno všech # záznamů}}.",
    ...
    "record.form-template-version": "Verze šablony: {version}",
    ...
    "Cannot generate Person URI due to unsupported encoding.":
      "Nelze vygenerovat Person URI kvůli nepodporovanému kódování.",
    ...
    "Your browser is not fully supported! Some parts of web may not work properly.":
      "Váš prohlížeč není plně podporován! Některé části stránek nemusí fungovat správně.",
