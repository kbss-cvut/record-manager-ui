...
class Institution extends React.Component {
  ...
  render() {
    const { currentUser, institution, recordsLoaded, formTemplatesLoaded } = this.props;
                ...
                <div className="row">
                  <div className="col-12 col-sm-6">
                    <HorizontalInput
                      ...
                      disabled={!canWriteInstitution(currentUser, institution)}
  ...
  _renderButtons() {
    ...
    if (!canWriteInstitution(currentUser, institution)) {
      return (
    ...
    return (
      <div className="mt-3 text-center">
        ...
        >
          ...
          {institutionSaved.status === ACTION_STATUS.PENDING && <LoaderSmall />}
        </Button>
  ...
  _renderMembers() {
    ...
    return (
      <InstitutionMembers
        ...
        onEditUser={handlers.onEditUser}
        userDeleted={userDeleted}
        onAddNewUser={handlers.onAddNewUser}
        currentUser={currentUser}
      />
    );
  }
