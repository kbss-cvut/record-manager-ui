    ...
    return (
      <div className="main-view-wrapper">
        <header>
          <Container>
            <Navbar expand="lg">
              <Navbar.Brand onClick={() => this.props.history.push(Routes.dashboard.path)}>
                {Constants.APP_NAME}
              </Navbar.Brand>
              <Navbar.Toggle />
              <Navbar.Collapse className="justify-content-between">
                ...
                <Nav>
                  ...
                  <NavDropdown className="pr-0" id="logout" title={name}>
                    ...
                    <NavDropdown.Item onClick={() => transitionTo(Routes.logout)}>
                      {this.i18n("main.logout")}
                    </NavDropdown.Item>
                  </NavDropdown>
                </Nav>
              </Navbar.Collapse>
