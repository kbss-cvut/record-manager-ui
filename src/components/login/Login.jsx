      ...
      <Card variant="info" className="login-panel">
        ...
        <Card.Body>
          ...
          {this.state.showAlert && this.props.error && (
            <div>
              <AlertMessage type={ALERT_TYPES.DANGER} alertPosition={"top"} message={this.i18n("login.error")} />
            </div>
          )}
          <Form>
            <HorizontalInput
              ...
              label={this.i18n("login.username")}
            ...
            <div className="login-forgot-password-block">
              <Button variant="link" className="login-forgot-password" size="sm" onClick={this.onForgotPassword}>
                {this.i18n("login.forgot-password")}
              </Button>
            </div>
            <div>
              <Button
              ...
              >
                ...
                {this.props.isLogging && <LoaderSmall />}
              </Button>
            </div>
          </Form>
        </Card.Body>
