...
export const authRoutes = (
  <Switch>
    ...
    <Route exact path={Routes.users.path} component={requireAuth(UsersController)} />
    ...
    <Route exact path={Routes.records.path} component={requireAuth(RecordsController)} />
    <Route exact path={Routes.createRecord.path} render={(routeProps) => <RecordController {...routeProps} />}></Route>
    <Route exact path={Routes.editRecord.path} render={(routeProps) => <RecordController {...routeProps} />}></Route>
